/// <reference path="echarts-init.js" />
// ============================================================== 
// Bar chart option
// ============================================================== 
    ...
    series: [
        {
            ...
            axisLabel: {           // 坐� �轴文本� �签，详见axis.axisLabel
                textStyle: {       // 其余属性默认使用全局文本� �式，详见TEXTSTYLE
                    color: 'auto'
                }
            },
            splitLine: {           // 分隔线
                ...
                lineStyle: {       // 属性lineStyle（详见lineStyle）控制线条� �式
                    color: 'auto'
                }
            },
            pointer: {
