...
namespace AVBS.Admin.UI.Areas.References.Controllers {
    [Authentication]
    public class IngredientController : IController< AVBS_Ingredient, BaseBusiness<AVBS_Ingredient>> {
        ...
        public override void ModelOperations ( ref AVBS_Ingredient model ) {
        ...
        public JsonResult GetList (  JQueryDataTableParam param, int locationid = 0 ) {
            ...
            try {
                var cashBookBusiness = new BaseBusiness<AVBS_Ingredient>();
                ...
                // Configure Order
                var orderingFunction = new Func<AVBS_Ingredient, object>( c => c.Id );
                if ( orderColumn == 0 ) {
